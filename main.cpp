...
int main()
{
    ...
    // std::cout << "трёхмерные тетраэдральныесет-ки, разрывный метод Галёркина, матрица масс(интегралов по тетраэдру)" << std::endl;
    // std::cout << "Размер тетраэдра dx(1.2, 2.1, 1.3), Якобиан 1,25(от фанаря похер)))" << std::endl;
